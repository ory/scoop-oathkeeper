...
# Contribute to Ory scoop-oathkeeper<!-- omit in toc -->
...
_Please note_: We take Ory scoop-oathkeeper's security and our users' trust very
seriously. If you believe you have found a security issue in Ory scoop-oathkeeper,
...
scoop-oathkeeper's direction. A great way to
do this is via
[Ory scoop-oathkeeper Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/scoop-oathkeeper/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory scoop-oathkeeper?](#communication)
...
- I want to talk to other Ory scoop-oathkeeper users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  scoop-oathkeeper.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/scoop-oathkeeper)

- I would like updates about new versions of Ory scoop-oathkeeper.
...
[list of good first issues](https://github.com/ory/scoop-oathkeeper/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory scoop-oathkeeper.
...
- **Help with open issues.** We have a lot of open issues for Ory scoop-oathkeeper and
...
Check out [Ory scoop-oathkeeper Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory scoop-oathkeeper,
...
before getting started to ensure your work is consistent with Ory scoop-oathkeeper's
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/scoop-oathkeeper/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/scoop-oathkeeper).
...
git clone git@github.com:ory/ory/scoop-oathkeeper.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/scoop-oathkeeper.git
